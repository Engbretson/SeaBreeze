...
/* Generated from ../O.Common/SeaBreezeApp.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "bo", "busy", "calc", "calcout", "compress", "dfanout", "event",
    "fanout", "histogram", "int64in", "int64out", "longin", "longout",
    "lsi", "lso", "mbbi", "mbbiDirect", "mbbo", "mbboDirect",
    "permissive", "printf", "scalcout", "scanparm", "sel", "seq", "sscan",
...
static const recordTypeLocation rtl[] = {
    ...
    {(struct typed_rset *)pvar_rset_aliveRSET, pvar_func_aliveRecordSizeOffset},
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "devAiStats", "devAiClusts",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32",
    "asynAoFloat64", "devAoStats", "asynRecordDevice", "devBiSoft",
    ...
    "devSWaitIoEvent", "devWfSoft", "devWfPDBDemo",
    ...
    "asynFloat64TimeSeries", "devWaveformStats"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devWfPDBDemo, pvar_dset_asynWfOctetCmdResponse,
...
epicsShareExtern reg_func pvar_func_NDAttrPlotRegister,
    ...
    pvar_func_NDFFTRegister, pvar_func_NDFileHDF5Register,
    pvar_func_NDFileJPEGRegister, pvar_func_NDFileMagickRegister,
    pvar_func_NDFileNetCDFRegister, pvar_func_NDFileNexusRegister,
    pvar_func_NDFileNullRegister, pvar_func_NDFileTIFFRegister,
    pvar_func_NDGatherRegister, pvar_func_NDOverlayRegister,
    pvar_func_NDProcessRegister, pvar_func_NDPvaRegister,
    ...
    pvar_func_NDTransformRegister, pvar_func_QSRVRegistrar,
    pvar_func_SeaBreezeSpecRegister, pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_dbrestoreRegister, pvar_func_installPVAAddLinkHook,
    pvar_func_interpRegister, pvar_func_parseRegister,
...
int SeaBreezeApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "Z:/epics/synApps_6_0/support/areaDetector-R3-4/ADSeaBreeze/iocs/ADSeaBreezeIOC";
    ...
    pvar_func_SeaBreezeSpecRegister();
...
/* SeaBreezeApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"SeaBreezeApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    SeaBreezeApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
